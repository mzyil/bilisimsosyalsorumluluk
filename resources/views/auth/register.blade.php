				...
				<div class="panel-body">
					@if (count($errors) > 0)
						<div class="alert alert-danger">
							<strong>Hay aksi!</strong> Verdiğiniz bilgilerde hatalar var.<br><br>
							<ul>
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Neden Buradasınız?</label>
							<div class="col-md-6">
								<select class="form-control">
									<option>Yardıma ihtiyacım var</option>
									<option>Yardım etmek istiyorum</option>
								</select>
							</div>
						</div>
						<div class="form-group">
